...
export const DiscordArrowIcon = ({ size = "24", className }: any) => {
    return (
...
export const DiscordHashIcon = ({ size = "24", className }: any) => {
    return (
        <svg
            width={size}
            height={size}
...
export const DiscordDownloadIcon = ({ className }: any) => (
    <svg
        className={className}
        aria-hidden="false"
        width="24"
...
export const DiscordAddIcon = ({ className }: any) => {
    return (
        <svg
            className={className}
            aria-hidden="true"
...
export const DiscordThreadsIcon = ({ className }: any) => {
    return (
        <svg
            x="0"
            y="0"
...
export const DiscordNotificationIcon = ({ className }: any) => {
    return (
        <svg
            x="0"
            y="0"
...
export const DiscordPinIcon = ({ className }: any) => {
    return (
        <svg
            x="0"
            y="0"
...
export const DiscordMemberIcon = ({ className }: any) => {
    return (
        <svg
            x="0"
            y="0"
...
export const DiscordInboxIcon = ({ className }: any) => {
    return (
        <svg
            x="0"
            y="0"
...
export const DiscordHelpIcon = ({ className }: any) => {
    return (
        <svg
            x="0"
            y="0"
...
export const DiscordSearchIcon = ({ className }: any) => {
    return (
        <svg
            className={className}
            aria-hidden="true"
...
export const DiscordCrossIcon = ({ className }: any) => {
    return (
        <svg
            className={className}
            aria-hidden="true"
...
export const DiscordMicIcon = ({ className }: any) => {
    return (
        <svg
            className={className}
            aria-hidden="true"
...
export const DiscordHeadsetIcon = ({ className }: any) => {
    return (
        <svg
            className={className}
            aria-hidden="true"
...
export const DiscordSettingsIcon = ({ className }: any) => {
    return (
        <svg
            className={className}
            aria-hidden="true"
